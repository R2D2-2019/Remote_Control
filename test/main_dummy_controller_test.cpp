...
TEST_CASE ( "testing buttons", " [interface]" ){
    ...
    //check joysticks
    CHECK( dummy_controller.get_joystick(r2d2::manual_control::joystick_l).x == 0 ); 
    CHECK( dummy_controller.get_joystick(r2d2::manual_control::joystick_l).y == 0 ); 
    CHECK( dummy_controller.get_joystick(r2d2::manual_control::joystick_r).x == 0 );
    CHECK( dummy_controller.get_joystick(r2d2::manual_control::joystick_r).y == 0 );
    ...
    CHECK( dummy_controller.get_joystick(r2d2::manual_control::joystick_l).x == 1 ); 
    CHECK( dummy_controller.get_joystick(r2d2::manual_control::joystick_l).y == 1 ); 
    CHECK( dummy_controller.get_joystick(r2d2::manual_control::joystick_r).x == 1 );
    CHECK( dummy_controller.get_joystick(r2d2::manual_control::joystick_r).y == 1 );
